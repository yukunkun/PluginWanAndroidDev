package com.wanandroid.ykk.pluglin_basic.adapter;
...
public class SearchAdapterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<SearchInfo.DatasBean> mFeedInfos ;
    Context mContext;
    ...
    public SearchAdapterAdapter(List<SearchInfo.DatasBean> feedInfos, Context context) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof MyHolder){
            final SearchInfo.DatasBean datasBean = mFeedInfos.get(position);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnItemClickListener.onItemClickListener(datasBean.getTitle(),datasBean.getLink());
                }
            });
