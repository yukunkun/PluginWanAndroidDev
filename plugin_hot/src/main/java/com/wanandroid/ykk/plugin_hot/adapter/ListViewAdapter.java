package com.wanandroid.ykk.plugin_hot.adapter;
...
public class ListViewAdapter extends BaseAdapter {
    ...
    public ListViewAdapter(Context context, List<CommonUrl> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView viewById = convertView.findViewById(R.id.tv_msg);
