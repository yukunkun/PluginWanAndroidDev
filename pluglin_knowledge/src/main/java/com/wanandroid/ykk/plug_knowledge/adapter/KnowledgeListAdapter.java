...
public class KnowledgeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<KnowledgeListInfo.DatasBean> mFeedInfos ;
    Context mContext;
    ...
    public KnowledgeListAdapter(Context context, List<KnowledgeListInfo.DatasBean> feedInfos) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof MyHolder){
            final KnowledgeListInfo.DatasBean datasBean = mFeedInfos.get(position);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnItemClickListener.onItemClick(datasBean.getTitle(),datasBean.getLink());
                }
            });
